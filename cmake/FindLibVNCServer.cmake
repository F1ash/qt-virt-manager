...
pkg_check_modules(PC_LIBVNCSERVER QUIET libvncserver libvnc)
...
FIND_LIBRARY(LIBVNCSERVER_LIBRARIES NAMES vncserver libvncserver libvnc) 
...
#IF (APPLE)
#  set(LIBVNCCLIENT_LIBRARIES "${LIBVNCSERVER_LIBRARIES}")
#ENDIF (APPLE)
