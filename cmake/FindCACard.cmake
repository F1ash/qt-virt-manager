...
IF (CACard_INCLUDE_DIR AND CACard_LIBRARIES)
   # in cache already
   SET(CACard_FIND_QUIETLY TRUE)
ELSE (CACard_INCLUDE_DIR AND CACard_LIBRARIES)
   SET(CACard_FIND_QUIETLY FALSE)
ENDIF (CACard_INCLUDE_DIR AND CACard_LIBRARIES)
...
IF (NOT WIN32)
   ...
   SET(CACard_DEFINITIONS ${PC_CACard_CFLAGS_OTHER})
ENDIF (NOT WIN32)

FIND_PATH(CACard_INCLUDE_DIR vreader.h
   PATHS
   ${PC_CACard_INCLUDEDIR}
   ${PC_CACard_INCLUDE_DIRS}
...
SET( CACard_LIBRARIES ${_CACardLibs} )
SET( CACard_INCLUDE_DIRS ${CACard_INCLUDE_DIR} )
...
IF (CACard_FOUND)
   IF (NOT CACard_FIND_QUIETLY)
      ...
      MESSAGE(STATUS "Found CACard includes : ${CACard_INCLUDE_DIR}")
...
MARK_AS_ADVANCED(CACard_INCLUDE_DIR _CACardLibs)
