...
{
    disconnect(useAdvanced, SIGNAL(toggled(bool)), this, SLOT(advancedVisibility(bool)));
    disconnect(ok, SIGNAL(clicked()), this, SLOT(migrateClicked()));
    disconnect(cancel, SIGNAL(clicked()), this, SLOT(cancelClicked()));
    disconnect(connectList, SIGNAL(currentIndexChanged(int)), this, SLOT(connectChanged(int)));
    disconnect(bandWdthCheck, SIGNAL(toggled(bool)), this, SLOT(bandWdthVisibility(bool)));
    disconnect(maxDownCheck, SIGNAL(toggled(bool)), this, SLOT(maxDownTimeVisibility(bool)));
    disconnect(nativeMigration, SIGNAL(clicked()), this, SLOT(migrTransportChanged()));
    disconnect(tunnelMigration, SIGNAL(clicked()), this, SLOT(migrTransportChanged()));
    disconnect(p2pCheck, SIGNAL(clicked(bool)), this, SLOT(p2pChanged(bool)));
