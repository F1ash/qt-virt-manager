      ...
      m_initWorkDir(work_dir)
{
    ...
    consoleTabulator->addNewTab(QString("<%2> Domain Terminal in <%1> Connect").arg(arg1).arg(arg2));

    setWindowTitle(QString("<%2> Domain Terminal in <%1> Connect").arg(arg1).arg(arg2));
