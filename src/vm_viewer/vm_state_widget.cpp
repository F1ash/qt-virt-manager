    ...
    QWidget(parent)
{
    ...
    smartCard->setObjectName(tr("SmartCard channel"));
    mouse->setObjectName(tr("Cursor channel"));
    keyboard->setObjectName(tr("Inputs channel"));
    display->setObjectName(tr("Display channel"));
    usbRedir->setObjectName(tr("USB Redirect channel"));
    webdav->setObjectName(tr("WebDAV channel"));
    playback->setObjectName(tr("Playback channel"));
    record->setObjectName(tr("Record channel"));
